var library = {
    ...
    cacheDom: function() {
        ...
        this.$bookPages = document.getElementById('num-pages');
        this.$readStatus = document.getElementById('already-read');

        this.$openForm = document.getElementById("open-form");
        this.$closeForm = document.getElementById("close-form");
        this.$submitForm = document.getElementById("submit-form")
    },
    bindEvents: function() {
        this.$submitForm.addEventListener("click", addNewBook.bind(this));
    },
    render: function() {
    ...
    addNewBook: function() {
        var Book = {};
        // Book.id = id;
        Book.title = this.$bookTitle.value;
        Book.author = this.$bookAuthor.value;
        Book.pages = this.$bookPages.value;
        Book.hasRead = "";
        Book.setReadStatus = function(status) {
            if (status == true) 
                Book.hasRead = "Already Read";
            else
                Book.hasRead = "Not Read Yet";
        };
        Book.setReadStatus(this.$readStatus.value);
